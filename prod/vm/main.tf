...
resource "aws_key_pair" "key1" {
  key_name   = "key1"
  public_key = file("/home/ec2-user/environment/Project/prod/vm/key1.pub")
}
...
resource "aws_key_pair" "key2" {
  ...
  public_key = file("/home/ec2-user/environment/Project/prod/vm/key2.pub")
}
...
resource "aws_key_pair" "key3" {
  key_name   = "key3"
  public_key = file("/home/ec2-user/environment/Project/prod/vm/key3.pub")
}
